...
/**
 * Diese Klasse dient als Basisklasse f�r allen Callback-Klassen. Eine Anwendung
...
public abstract class AbstractHBCICallback implements HBCICallback {
     ...
     * Callback-Klassen f�r die Erzeugung von Log-Eintr�gen verwendet. Um ein
     * eigenes Format f�r die Log-Eintrage zu definieren, kann diese Methode mit
     * einer eigenen Implementierung �berschrieben werden.<br/> Die Parameter
    ...
    /**
     * Standard-Verhalten - gibt f�r alle Callbacks <code>false</code> (=
     * asynchrone Callback-Behandlung) zur�ck.
     */
