...
/**
 * <p>Menge zusammengeh�riger Status-Informationen. In Objekten dieser Klasse
 * kann eine Menge von HBCI-Statuscodes sowie eine Menge von Exceptions
 * gespeichert werden. Der Sinn dieser Klasse ist die Zusammenfassung von
 * mehreren Status-Informationen, die logisch zusammengeh�ren (z.B. alle
 * Status-Informationen, die ein bestimmtes Nachrichtensegment betreffen).
 * </p><p> Objekte dieser Klasse werden beispielsweise in {@link
 * org.kapott.hbci.status.HBCIMsgStatus} verwendet, um globale und
 * segmentbezogene Status-Informationen voneinander getrennt zu sammeln. </p>
 */
public final class HBCIStatus implements Serializable {
    /**
     * Statuscode f�r "alle Statusinformationen besagen OK"
     */
    public static final int STATUS_OK = 0;
    /**
     * Statuscode f�r "Gesamtstatus kann nicht ermittelt werden". (z.B. weil gar
     * keine Informationen in diesem Objekt enthalten sind)
     */
    ...
    public void addRetVal (HBCIRetVal ret) {
        retVals.add(ret);
        if (ret.isError()) {
            HBCIUtils.log("HBCI error code: " + ret.toString(),
                    HBCIUtils.LOG_ERR);
        }
    }
     ...
     *
     * @return <code>true</code>, falls Exceptions gespeichert sind, sonst
     * <code>false</code>
     */
     ...
     * enthalten sind
     *
     * @return <code>true</code>, falls Fehlermeldungen vorhanden sind, sonst
     * <code>false</code>
     */
    ...
    /**
     * Gibt zur�ck, ob in den R�ckgabedaten in diesem Objekt Warnungen enthalten
     * sind
     *
     * @return <code>true</code>, falls Warnungen vorhanden sind, sonst
     * <code>false</code>
     */
     ...
     * enthalten sind
     *
     * @return <code>true</code>, falls Erfolgsmeldungen vorhanden sind, sonst
     * <code>false</code>
     */
     ...
     *
     * @return Array mit <code>HBCIRetVal</code>s, die w�hrend der
     * HBCI-Kommunikation aufgetreten sind.
     */
     ...
     *
     * @return Array mit HBCI-Returncodes, die allesamt Fehlermeldungen
     * beschreiben
     */
     ...
     *
     * @return Array mit HBCI-Returncodes, die allesamt Warnmeldungen
     * beschreiben
     */
     ...
     *
     * @return Array mit HBCI-Returncodes, die allesamt Erfolgsmeldungen
     * beschreiben
     */
     ...
     * M�glichkeiten: <ul> <li><code>STATUS_OK</code> wird zur�ckgegeben, wenn
     * es keine Fehlermeldungen oder Exceptions gegeben hat und mindestens eine
     * Erfolgsmeldung oder Warnung enthalten ist</li> <li><code>STATUS_ERR</code>
     * wird zur�ckgegeben, wenn wenigstens eine Exception aufgetreten ist oder
     * wenigstens eine Fehlermeldung enthalten ist.</li>
     * <li><code>STATUS_UNKNOWN</code> wird zur�ckgegeben, wenn keine der beiden
     * o.g. Bedingungen zutrifft.</li> </ul>
     *
     ...
     * aufgetreten sind und wenigstens eine Successmeldung oder Warnung
     * enthalten ist
     */
    public boolean isOK () {
     ...
     * die entsprechende Beschreibung in Kurz (siehe {@link
     * org.kapott.hbci.manager.HBCIUtils#exception2StringShort(Exception)})
     * benutzt.
     *
