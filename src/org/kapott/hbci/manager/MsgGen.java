...
public final class MsgGen {
    ...
    /**
     * < @internal @brief The representation of the syntax used by this
     * generator
     */
    private Hashtable<String, String> clientValues;

    /**
     * < @internal @brief A table of properties set by the user to specify the
    ...
    /**
     * @param msgName The name (i.e. XML-identifier for a MSGdef-node) of the
     * message to be generated.
    ...
    /**
     * @param path The path to the syntax element for which the value is to be
     * set. For more information about paths, see SyntaxElement::SyntaxElement()
    ...
    public List<String> getGVParameterNames (String specname) {
        ...
        return getGVParameterNames(specname.substring(0, versionPos + 1), specname.substring(versionPos + 1));
    }
    ...
    public List<String> getGVResultNames (String specname) {
        ...
        return getGVResultNames(specname.substring(0, versionPos + 1), specname.substring(versionPos + 1));
    }
    ...
    public List<String> getGVRestrictionNames (String specname) {
        ...
        return getGVRestrictionNames(specname.substring(0, versionPos + 1), specname.substring(versionPos + 1));
    }
